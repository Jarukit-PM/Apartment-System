  ...
  return (
    <div className="ap-ambient-bg flex min-h-dvh flex-col md:flex-row">
      {mobileOpen ? (
        <button
          type="button"
          className="fixed inset-0 z-30 bg-[#1c1916]/40 backdrop-blur-[2px] md:hidden"
      ...
      <aside
        ...
        aria-hidden={isMobile && !mobileOpen ? true : !isMobile && !sidebarVisibleOnDesktop ? true : undefined}
        className={`${sidebarClass} fixed inset-y-0 left-0 z-40 md:static`}
      >
