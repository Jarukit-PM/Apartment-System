...
func NewServer(p *property.Service, u *unit.Service, r *resident.Service, l *lease.Service, m *maintenance.Service) *Server {
	return &Server{Props: p, Units: u, Res: r, Leases: l, Maint: m}
}
